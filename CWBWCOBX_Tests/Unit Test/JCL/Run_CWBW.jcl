//HSTJXL0W JOB ('ACCOUNTING INFO'),'NAME',NOTIFY=&SYSUID,CLASS=A,
...
//        DD DISP=SHR,DSN=SALESSUP.JXL1.PRD.LOAD
//        DD DISP=SHR,DSN=SALESSUP.JXL1.QA1.LOAD
//        DD DISP=SHR,DSN=SALESSUP.JXL1.STG.LOAD
//*
//EMPFILE  DD   DSN=SYS2.CW.&CWGAXT..SLXTSAMP(CWXTDATA),
//         DISP=SHR
//RPTFILE  DD   SYSOUT=X
//SYSOUT   DD   SYSOUT=X
//SLSF002 DD DSN=SALESSUP.JXL1.PRD.SSD,DISP=SHR
//SLSF004 DD DSN=SALESSUP.JXL1.QA1.SSD,DISP=SHR
//SLSF008 DD DSN=SALESSUP.JXL1.STG.SSD,DISP=SHR
//TRPARM DD *
*
